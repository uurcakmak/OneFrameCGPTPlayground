document.title = "OneFrame API Documentation";
...
(function () {
    window.addEventListener("load", function () {
        setTimeout(function () {
            ...
            logo[0].href = "http://oneframe.kocsistem.com.tr";
            logo[0].target = "_blank";

            // Section 02 - Set logo
            logo[0].children[0].alt = "OneFrame";
            logo[0].children[0].src = "/swagger-ui/resources/one-frame-logo.svg";
