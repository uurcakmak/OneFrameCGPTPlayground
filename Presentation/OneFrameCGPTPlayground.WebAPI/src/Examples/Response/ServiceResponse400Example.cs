// <copyright file="ServiceResponse400Example.cs" company="KocSistem">
...
namespace OneFrameCGPTPlayground.WebAPI.Examples.Response
{
    ...
    internal class ServiceResponse400Example : IExamplesProvider<ServiceResponse>
    {
        public ServiceResponse GetExamples()
        {
            return new ServiceResponse
            {
                ...
                Error = new ErrorInfo
                {
                    ...
                    {
                        new ValidationErrorInfo("validation error item detail"),
                    },
                },
            };
        }
