// <copyright file="ApplicationSettingGetResponseExample.cs" company="KocSistem">
...
namespace OneFrameCGPTPlayground.WebAPI.Examples.Response
{
    ...
    public class ApplicationSettingGetResponseExample : IExamplesProvider<ServiceResponse<PagedResult<ApplicationSettingResponse>>>
    {
