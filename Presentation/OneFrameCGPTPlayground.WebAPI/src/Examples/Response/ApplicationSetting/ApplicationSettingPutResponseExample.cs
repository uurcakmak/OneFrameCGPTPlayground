// <copyright file="ApplicationSettingPutResponseExample.cs" company="KocSistem">
...
namespace OneFrameCGPTPlayground.WebAPI.Examples.Response
{
    ...
    public class ApplicationSettingPutResponseExample : IExamplesProvider<ServiceResponse<ApplicationSettingResponse>>
    {
