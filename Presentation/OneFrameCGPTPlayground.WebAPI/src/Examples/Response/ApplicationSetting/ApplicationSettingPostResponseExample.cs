// <copyright file="ApplicationSettingPostResponseExample.cs" company="KocSistem">
...
namespace OneFrameCGPTPlayground.WebAPI.Examples.Response
{
    ...
    public class ApplicationSettingPostResponseExample : IExamplesProvider<ServiceResponse<ApplicationSettingResponse>>
    {
