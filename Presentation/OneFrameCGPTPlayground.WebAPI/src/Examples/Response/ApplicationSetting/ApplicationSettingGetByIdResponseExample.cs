// <copyright file="ApplicationSettingGetByIdResponseExample.cs" company="KocSistem">
...
namespace OneFrameCGPTPlayground.WebAPI.Examples.Response
{
    ...
    public class ApplicationSettingGetByIdResponseExample : IExamplesProvider<ServiceResponse<ApplicationSettingResponse>>
    {
