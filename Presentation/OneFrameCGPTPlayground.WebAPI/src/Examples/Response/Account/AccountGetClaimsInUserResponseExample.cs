// <copyright file="AccountGetClaimsInUserResponseExample.cs" company="KocSistem">
...
namespace OneFrameCGPTPlayground.WebAPI.Examples.Response
{
    ...
    internal class AccountGetClaimsInUserResponseExample : IExamplesProvider<ServiceResponse<List<ClaimResponse>>>
    {
