// <copyright file="AccountGetUserClaimsTreeResponseExample.cs" company="KocSistem">
...
namespace OneFrameCGPTPlayground.WebAPI.Examples.Response
{
    ...
    internal class AccountGetUserClaimsTreeResponseExample : IExamplesProvider<ServiceResponse<List<ClaimTreeViewItem>>>
    {
