// <copyright file="ApplicationSettingCategoryGetByIdResponseExample.cs" company="KocSistem">
...
namespace OneFrameCGPTPlayground.WebAPI.Examples.Response
{
    ...
    public class ApplicationSettingCategoryGetByIdResponseExample : IExamplesProvider<ServiceResponse<ApplicationSettingCategoryResponse>>
    {
