// <copyright file="LanguagePostRequestExample.cs" company="KocSistem">
...
{
    public class LanguagePostRequestExample : IExamplesProvider<LanguagePostRequest>
    {
        public LanguagePostRequest GetExamples()
        {
            return new LanguagePostRequest()
            {
                Name = "English",
                Code = "en-EN",
                IsDefault = true,
